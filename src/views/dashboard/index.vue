      ...
      <div class="group_box">
        <div class="group_item_box">
          <div class="group_body_box head">
            ...
            <img class="refresh_btn" @click.stop="refreshComponent(0)" src="@/assets/images/components/refresh_btn.png" alt="" />
        ...
        <div class="group_item_box">
          <div class="group_body_box body">
            ...
            <img class="refresh_btn" @click.stop="refreshComponent(1)" src="@/assets/images/components/refresh_btn.png" alt="" />
        ...
        <div class="group_item_box">
          <div class="group_body_box weapon">
            ...
            <img class="refresh_btn" @click.stop="refreshComponent(2)" src="@/assets/images/components/refresh_btn.png" alt="" />
